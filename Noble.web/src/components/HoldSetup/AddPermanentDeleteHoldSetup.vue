                ...
                <div class="col-lg-12">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="modal-header">
                            <h6 class="modal-title m-0" id="myModalLabel">Permanent Delete Hold Setup</h6>
                            <button type="button" class="btn-close" v-on:click="close()"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="inline-fields col-md-12 mb-2">
                                    <multiselect :options="['1 Week', '2 Weeks', '3 Weeks', '1 Month']"
    ...
    methods: {
        ...
        SaveData: function () {
            ...
            this.$swal({
                ...
                text: (this.$i18n.locale == 'en' || this.isLeftToRight()) ? 'You will not be able to recover this!' : 'سوف تكون قادرا على استعادة هذا!',
                type: "warning",
                ...
                if (result) {
                    ...
                    root.$https.post('/Region/SavePermanentDeleteHoldTypeSetup', root.brand, {
                        headers: {
