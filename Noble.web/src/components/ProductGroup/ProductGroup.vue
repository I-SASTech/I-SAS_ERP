            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">{{ $t('ProductGroup.ProductGroup') }}</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $t('ProductGroup.Home') }}</a></li>
                                    <li class="breadcrumb-item active">{{ $t('ProductGroup.ProductGroup') }}</li>
                                </ol>
                            </div>
                            ...
                            <thead class="thead-light table-hover">
                                <tr>
                                    ...
                                    <th v-if="isOtherLang()" width="20%">
                                        {{$arabicLanguage($t('AddProductGroup.NameArabic'))  }}
                                    </th>
    ...
    export default {
        ...
        clearData: function () {
            ...
            GetColorData: function () {
                ...
                root.$https.get('Product/ProductGroupList?pageNumber=' + this.currentPage + '&searchTerm=' + this.search, { headers: { "Authorization": `Bearer ${token}` } }).then(function (response) {
            ...
            EditColor: function (id) {
                ...
                root.$https.get('/Product/ProductGroupDetail?id=' + id, { headers: { "Authorization": `Bearer ${token}` } })
                    .then(function (response) {
                        if (response.data) {
                            ...
                            root.newColor.productList = response.data.productList;
