                    ...
                    <div class="page-title-box">
                        <div class="row">
                            ...
                            <div class="col-auto align-self-center">
                                <a v-on:click="AddWareHouseTransfer" href="javascript:void(0);"
                                    class="btn btn-sm btn-outline-primary mx-1" v-if="!mainBranch">
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr v-for="( item, index ) in wareHouseTransferList" :key="item.id">
                                            ...
                                            <td>
                                                {{ item.stockRequestStatus }}
                                            </td>
                                            <td v-if="item.stockRequestStatus == 0">
                                                Default
                                            </td>
                                            <td v-if="item.stockRequestStatus == 1">
                                                Paritially
                                            </td>
                                            <td v-if="item.stockRequestStatus == 2">
                                                Fully
                                            </td>
                                            <td class="text-end">
...
export default {
    ...
    methods: {
        ...
        EditWareHouseTransfer: function (id) {
            ...
            root.$https.get('/Purchase/GetStockRequestDetails?Id=' + id, { headers: { "Authorization": `Bearer ${token}` } })
        ...
        PrintRdlc: function (id, isDownload) {
            ...
            if (isDownload) {
                this.loading = true;
                this.$https.get(this.$ReportServer + '/Stocks/StocksReport.aspx?id=' + id + '&CompanyId=' + companyId + '&formName=StockRequestReport' + '&isDownload=' + isDownload
                ...
                this.reportsrc = this.$ReportServer + '/Stocks/StocksReport.aspx?id=' + id + '&CompanyId=' + companyId + '&formName=StockRequestReport' + '&isDownload=' + isDownload
                this.changereport++;
            }
        },
        ...
        getData: function (currentPage, status) {
            ...
            this.$https.get('/Purchase/GetStockRequestList?status=' + status + '&searchTerm=' + this.search + '&pageNumber=' + currentPage + '&fromDate=' + this.fromDate + '&toDate=' + this.toDate + '&branchId=' + branchId, { headers: { "Authorization": `Bearer ${token}` } })
                .then(function (response) {
                    if (response.data != null) {
      ...
      //      this.$router.push('/addstockrequest');
                     this.$router.push({
                            path: '/addstockrequest',
                            query: { 
                                Add: true, }
