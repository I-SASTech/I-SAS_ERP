<template>
    <div class="row"
         v-if="isValid('CanAddSaleOrder') || (isValid('CanAddSaleOrderTracking') && formName == 'SaleOrderTracking') || isValid('CanDraftSaleOrder') || (isValid('CanDraftSaleOrderTracking') && formName == 'SaleOrderTracking') || isValid('CanEditSaleOrder') || (isValid('CanEditSaleOrderTracking') && formName == 'SaleOrderTracking') || isValid('CanDuplicateSaleOrder') || (isValid('CanDuplicateSaleOrderTracking') && formName == 'SaleOrderTracking')">
        <div class="col-lg-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 v-if="purchase.id === '00000000-0000-0000-0000-000000000000' && formName == 'SaleOrderTracking'"
                                    class="page-title">
                                    {{ $t('AddSaleOrder.SalesOrderTracking') }}
                                </h4>
                                <h4 v-else-if="purchase.id === '00000000-0000-0000-0000-000000000000'"
                                    class="page-title">
                                    {{ $t('AddSaleOrder.AddSaleOrder') }}
                                </h4>
                                <h4 v-else-if="purchase.id !== '00000000-0000-0000-0000-000000000000' && formName == 'SaleOrderTracking'"
                                    class="page-title">
                                    {{ $t('AddSaleOrder.UpdateSaleOrderTracking') }}
                                </h4>
                                <h4 v-else class="page-title">{{ $t('AddSaleOrder.UpdateSaleOrder') }}</h4>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row form-group" v-bind:key="randerCustomer">
                        ...
                        <div class="inline-fields col-lg-8">
                            <customerdropdown v-model="v$.purchase.customerId.$model"
                                              ...
                                              :modelValue="purchase.customerId" :key="customerRender" />
                            <a href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                               aria-controls="offcanvasRight" class="text-primary">
                                {{
                                    $t('AddSaleOrder.ViewCustomerDetails')
                                }}
                            </a>
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                                ...
                                <div class="offcanvas-header">
                                    <h5 id="offcanvasRightLabel" class="m-0">
                                        {{ $t('AddSaleOrder.CustomerDetails') }}
                                    </h5>
                                ...
                                <div class="offcanvas-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 form-group">
                                            <label>{{ $t('AddSaleOrder.Address') }} :</label>
                    ...
                    <div class="row form-group" v-if="formName == 'SaleOrderTracking'">
                        <label class="col-form-label col-lg-4">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">
                                {{
                                $t('AddSaleOrder.ClientPurchaseNo')
                                }}
                            </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">
                                {{
                                $t('AddSaleOrder.Transporter/Cargo')
                                }}
                            </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row form-group"
                         v-if="saleOrder && (isValid('CanDraftQuotation') || isValid('CanViewQuotation'))">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">
                                {{
                                $t('AddSaleOrder.Quotation')
                                }}
                            </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                            <quotationdropdown v-model="purchase.quotationId"
                                               @update:modelValue="GetQuotationDetail(purchase.quotationId)"
                                               :modelValue="purchase.quotationId" />
                        </div>
                    </div>
                    ...
                    <div class="row form-group"
                         v-if="(purchase.paymentMethod == 'Cash' || purchase.paymentMethod == 'السيولة النقدية') && isRaw == 'true'">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">
                                {{
                                $t('AddSaleOrder.SheduleDelivery')
                                }}
                            </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                    ...
                    <div class="row form-group"
                         v-if="(purchase.sheduleDelivery == 'After Delivery' || purchase.sheduleDelivery == 'بعد الولادة') && (purchase.paymentMethod == 'Cash' || purchase.paymentMethod == 'السيولة النقدية') && isRaw == 'true'">
                        <label class="col-form-label col-lg-4">
                ...
                <saleorder-item @update:modelValue="SavePurchaseItems" ref="childComponentRef" :key="rander"
                ...
                <div class="col-lg-12 invoice-btn-fixed-bottom">
                    <div class="button-items" v-if="purchase.id === '00000000-0000-0000-0000-000000000000'">
                        ...
                        <div class="btn-group"
                             v-if="isValid('CanAddSaleOrder') || (isValid('CanAddSaleOrderTracking') && formName == 'SaleOrderTracking')">
                            <button v-on:click="savePurchase('Approved')"
                                    v-bind:disabled="v$.$invalid  || purchase.saleOrderItems.filter(x => x.unitPrice == '').length > 0 || purchase.saleOrderItems.filter(x => x.outOfStock).length > 0"
                                    type="button" class="btn btn-outline-primary me-0">
                                {{ $t('AddSaleOrder.SaveAsPost') }}
                            </button>
                            <button v-bind:disabled="v$.$invalid  || purchase.saleOrderItems.filter(x => x.unitPrice == '').length > 0 || purchase.saleOrderItems.filter(x => x.outOfStock).length > 0"
                            ...
                            <div class="dropdown-menu">
                                <a v-on:click="savePurchase('Approved', true)"
                                   v-if="(isValid('CanAddSaleOrder') || (isValid('CanAddSaleOrderTracking') && formName == 'SaleOrderTracking')) && (isValid('CanPrintSaleOrder') || (isValid('CanPrintSaleOrderTracking') && formName == 'SaleOrderTracking'))"
                    ...
                    <div class="button-items" v-else>
                        <button class="btn btn-outline-primary  mr-2" v-on:click="savePurchase('Draft')"
                                v-if="(isValid('CanDraftSaleOrder') || (isValid('CanDraftSaleOrderTracking') && formName == 'SaleOrderTracking')) && (isValid('CanEditSaleOrder') || (isValid('CanEditSaleOrderTracking') && formName == 'SaleOrderTracking'))"
                                v-bind:disabled="v$.$invalid  || purchase.saleOrderItems.filter(x => x.unitPrice == '').length > 0">
                            <i class="far fa-save"></i> {{ $t('AddSaleOrder.UpdateAsDraft') }}
                        </button>

                        <div class="btn-group"
                             v-if="(isValid('CanAddSaleOrder') || (isValid('CanAddSaleOrderTracking') && formName == 'SaleOrderTracking')) && (isValid('CanEditSaleOrder') || (isValid('CanEditSaleOrderTracking') && formName == 'SaleOrderTracking'))">
                            <button v-on:click="savePurchase('Approved')"
                                    v-bind:disabled="v$.$invalid  || purchase.saleOrderItems.filter(x => x.unitPrice == '').length > 0 || purchase.saleOrderItems.filter(x => x.outOfStock).length > 0"
                                    type="button" class="btn btn-outline-primary me-0">
                            ...
                            <div class="dropdown-menu">
                                <a v-on:click="savePurchase('Approved', true)"
                                   v-if="(isValid('CanAddSaleOrder') || (isValid('CanAddSaleOrderTracking') && formName == 'SaleOrderTracking')) && (isValid('CanEditSaleOrder') || (isValid('CanEditSaleOrderTracking') && formName == 'SaleOrderTracking')) && (isValid('CanPrintSaleOrder') || (isValid('CanPrintSaleOrderTracking') && formName == 'SaleOrderTracking'))"
                                   class="dropdown-item" href="javascript:void(0);">
                                    {{
                ...
                <div class="col-lg-12 mt-5 mb-5"
                     v-if="purchase.id != '00000000-0000-0000-0000-000000000000' && purchase.approvalStatus == 3">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-header p-3">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary "
                                       v-on:click="payment = true"> Add Payment</a>
                                </div>
                                <div class="accordion-body">
                                    <purchaseorder-payment :totalAmount="totalAmount"
                                                           ...
                                                           :purchaseOrderId="purchase.id" :formName="'BankReceipt'" />
...
<script>
    ...
    export default {
        ...
        methods: {
                        ...
                        .then(function (response) {
                            if (response.data != null) {
                                ...
                                response.data.quotationTemplateItems.forEach(function (so) {
                                    root.$refs.childComponentRef.addProduct(so.productId, so.product, undefined, undefined, undefined, so.quantity, so.unitPrice, true);
            ...
            getAddress: function () {
                if (this.custemerOldId != this.purchase.customerId) {
                ...
                this.custemerOldId = this.purchase.customerId;
            ...
            AutoIncrementCode: function () {
                ...
                if (this.formName == 'SaleOrderTracking') {
                    this.purchase.isSaleOrderTracking = true;
                }
                else {
                    this.purchase.isSaleOrderTracking = false;
                }
                ...
                root.$https
                    .get("/Purchase/SaleOrderAutoGenerateNo?terminalId=" + terminalId + '&invoicePrefix=' + localStorage.getItem('InvoicePrefix') + '&isSaleOrderTracking=' + this.purchase.isSaleOrderTracking, {
            ...
            savePurchase: function (status, print) {
                ...
                this.purchase.isFifo = this.isFifo;
            ...
            goToPurchase: function () {
                ...
                if (this.isValid('CanViewSaleOrder') || (this.isValid('CanViewSaleOrderTracking') && this.formName == 'SaleOrderTracking') || this.isValid('CanDraftSaleOrder') || (this.isValid('CanDraftSaleOrderTracking') && this.formName == 'SaleOrderTracking')) {
                    this.$router.push({
                        path: '/SaleOrder',
                        query: {
                            data: 'AddSaleOrders' + this.formName,
        ...
        created: function () {
            ...
            if (this.$route.query.data != undefined) {
                ...
                this.custemerOldId = this.$route.query.data.customerId;
                if (localStorage.getItem('IsMultiUnit') == 'true' && localStorage.getItem('decimalQuantity') == 'true') {
