        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col" v-if="formName == 'CustomerAdvances'">
                                <h4 class="page-title">{{ $t('Customer Advances Report') }}</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $t('CustomerBalanceReport.Home') }}</a></li>
                                    <li class="breadcrumb-item active">
                                        {{
                                            $t('Customer Advances Report')
                                        }}
                                    </li>
                                </ol>
                            </div>
                            <div class="col" v-if="formName == 'SupplierAdvances'">
                                <h4 class="page-title">{{ $t('Supplier Advances Report') }}</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $t('CustomerBalanceReport.Home') }}</a></li>
                                    <li class="breadcrumb-item active">
                                        {{
                                            $t('Supplier Advances Report')
                                        }}
                                    </li>
                                </ol>
                            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class=" col-lg-3   form-group" v-if="advanceFilters" id="hide">
                    <label v-if="formName == 'CustomerAdvances'">{{ $t('CustomerBalanceReport.CustomerName') }}</label>
                    <label v-if="formName == 'SupplierAdvances'">{{ $t('CustomerBalanceReport.SupplierName') }}</label>
    ...
    export default {
        ...
        watch: {
            formName: function () {
                ...
                if (this.formName == 'CustomerAdvances') {

                    this.PrintRdlc(this.fromDate, this.toDate, this.accountId, false);

                }
                if (this.formName == 'SupplierAdvances') {
        ...
        // },
            ...
            GetInventoryList: function (fromdate, todate, accountId) {
                ...
                this.$https.get('/Report/CustomerAdvancesReport?fromDate=' + fromdate + '&toDate=' + todate + '&accountId=' + accountId + '&documentName=' + this.formName, { headers: { "Authorization": `Bearer ${token}` } })
                    .then(function (response) {
                        if (response.data != null) {
            ...
            PrintRdlc: function (fromdate, todate, accountId, val) {
                ...
                if (val) {
                    this.reportsrc1 = this.$ReportServer + '/Invoice/A4_DefaultTempletForm.aspx?companyId=' + companyId + '&fromDate=' + fromdate + '&toDate=' + todate + '&documentName=' + this.formName + '&formName=' + this.formName + '&accountId=' + accountId + "&Print=" + val + "&branchId=" + this.branchId
                    this.changereportt++;
                    this.show = !this.show;
                }
                else {
                    this.reportsrc = this.$ReportServer + '/Invoice/A4_DefaultTempletForm.aspx?companyId=' + companyId + '&fromDate=' + fromdate + '&toDate=' + todate + '&documentName=' + this.formName + '&formName=' + this.formName + '&accountId=' + accountId + "&Print=" + val + "&branchId=" + this.branchId
                    this.changereport++;
                }
