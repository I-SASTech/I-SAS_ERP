            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col" v-if="documentName == 'CustomerSummary'">
                                <h4 class="page-title">{{ $t('Customer Advances Summary Report') }}</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $t('CustomerBalanceReport.Home') }}</a></li>
                                    <li class="breadcrumb-item active">
                                        {{
                                            $t('Customer Advances Summary Report')
                                        }}
                                    </li>
                                </ol>
                            </div>
                            <div class="col" v-if="documentName == 'SupplierSummary'">
                                <h4 class="page-title">{{ $t('Supplier Advances Summary Report') }}</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $t('CustomerBalanceReport.Home') }}</a></li>
                                    <li class="breadcrumb-item active">
                                        {{
                                            $t('Supplier Advances Summary Report')
                                        }}
                                    </li>
                                </ol>
                            </div>
...
export default {
    ...
    watch: {
        ...
        //     if (this.$route.query.documentName == "CustomerSummary") {
        ...
        documentName: function () {
            ...
            if (this.documentName == 'CustomerSummary') {

                this.getPage(this.fromDate, this.toDate);

            }
            if (this.documentName == 'SupplierSummary') {
    ...
    methods: {
        ...
        PrintRdlc: function (fromdate, todate, val) {
            ...
            if (val) {
                this.reportsrc1 = this.$ReportServer + '/Invoice/A4_DefaultTempletForm.aspx?companyId=' + companyId + '&fromDate=' + fromdate + '&toDate=' + todate + '&dateType=' + '&documentName=' + this.documentName + '&formName' + this.documentName + this.dateType + "&Print=" + val + "&branchId=" + this.branchId
                this.changereportt++;
                this.show = !this.show;
            }
            else {
                this.reportsrc = this.$ReportServer + '/Invoice/A4_DefaultTempletForm.aspx?companyId=' + companyId + '&fromDate=' + fromdate + '&toDate=' + todate + '&dateType=' + '&documentName=' + this.documentName + '&formName' + this.documentName + this.dateType + "&Print=" + val + "&branchId=" + this.branchId
                this.changereport++;
            }
