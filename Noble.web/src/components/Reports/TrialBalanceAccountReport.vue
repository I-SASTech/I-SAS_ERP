                            ...
                            <div class="col">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{
                                        $t('TrialBalanceAccountReport.Home') }}</a></li>
                                    <li class="breadcrumb-item active">{{ $t('TrialBalanceAccountReport.TrialBalanceReport')
                                    }}</li>
                                </ol>
                            </div>
...
export default {
    ...
    methods: {
        ...
        GetInventoryList: function (fromdate, todate) {
            ...
            this.$https.get('/Report/TrialBalanceAccountReportAsync?fromDate=' + fromdate + '&toDate=' + todate + "&branchId=" + this.branchId, { headers: { "Authorization": `Bearer ${token}` } })
        ...
        PrintRdlc: function (fromdate, todate, val) {
            ...
            if (val) {
                this.reportsrc1 = this.$ReportServer + '/ReportManagementModule/AccountFinanceReports/AccountFinanceReports.aspx?companyId=' + companyId + '&fromDate=' + fromdate + '&toDate=' + todate + '&formName=TrialBalanceAccountReport' + "&Print=" + val + "&branchId=" + this.branchId
                this.changereportt++;
                this.showReport = !this.showReport;
            }
            else {
                this.reportsrc = this.$ReportServer +  '/ReportManagementModule/AccountFinanceReports/AccountFinanceReports.aspx?companyId=' + companyId + '&fromDate=' + this.fromDate + '&toDate=' + this.toDate + '&formName=TrialBalanceAccountReport' + "&Print=" + val + "&branchId=" + this.branchId
                this.changereport++;
            }
        },
