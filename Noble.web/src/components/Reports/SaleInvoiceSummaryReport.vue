    ...
    methods: {
        ...
        PrintRdlc:function() {
            ...
            var companyId = '';
                        ...
                        this.reportsrc1=  this.$ReportServer+'/ReportManagementModule/SalePurchase/SalePurchaseReports.aspx?invoiceType=' + this.invoiceType + '&numberOfPeriods=' + this.numberOfPeriods + '&compareWith=' + this.compareWith +'&formName=SaleInvoiceSummary'+'&companyId='+companyId 
                        this.changereportt++;
                        this.show = !this.show;
                },
