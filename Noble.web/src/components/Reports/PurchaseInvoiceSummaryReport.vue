        ...
        <div class="col-lg-12">
            ...
            <div class="row align-items-center">
                <div class="row align-items-end">
                    <div class=" col-lg-4   form-group">
                        ...
                        <multiselect v-model="invoiceType" :options="['Purchase Inovice Post', 'Purchase Return']"
                    ...
                    <div class=" col-lg-4  form-group pe-0">
                        <button v-if="numberOfPeriods == 0" disabled href="javascript:void(0);"
                            class="btn btn-outline-primary me-2">
                            Apply Filters
                        </button>
                        <button v-else v-on:click="GetPurchaseList()" href="javascript:void(0);"
                            class="btn btn-outline-primary me-2">
                            Apply Filters
                        </button>
            ...
            <div class="row" v-if="showTable">
                ...
                <div class="card col-md-12">
                    ...
                    <div class="table-responsive" v-for="(sale, index) in purchasesList" :key="index">
...
export default {
    ...
    methods: {
        ...
        GetPurchaseList: function () {
            ...
            this.$https.get('/Report/GetPurchaseInvocieSummary?invoiceType=' + this.invoiceType + '&numberOfPeriods=' + this.numberOfPeriods + '&compareWith=' + this.compareWith + '&branchId=' + this.branchId, { headers: { "Authorization": `Bearer ${token}` } })
                .then(function (response) {
                    if (response.data != null) {
                        root.showTable = true;
                        root.purchasesList = response.data;
