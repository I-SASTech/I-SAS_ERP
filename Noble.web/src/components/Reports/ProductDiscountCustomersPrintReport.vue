            ...
            <div class="border border-dark col-md-12 my-1 " style="height:200mm;">
                ...
                <div class="row">
                    ...
                    <h6 class="m-auto" v-if="list.inventoryList.length > 0 && isPrint">
                       Customer Name : {{list.inventoryList[0].customerName}}
                    </h6>
                    <table class="table col-md-11 m-auto">
                        <tr class="heading" style="font-size:14px;">
                            <th class="text-left">#</th>
                            <th class="text-left">{{ $t('ProductDiscountCustomersPrintReport.Date') }}</th>
                            <th class="text-left">{{ $t('ProductDiscountCustomersPrintReport.ProductName') }}</th>
                            <th class="text-right">{{ $t('ProductDiscountCustomersPrintReport.QuantityOut') }}</th>
                            <th class="text-right">{{ $t('ProductDiscountCustomersPrintReport.SalePrice') }}</th>
                            <th v-if="isShown" class="text-right">{{ $t('ProductDiscountCustomersPrintReport.FixedDiscount') }}</th>
                            <th v-if="!isShown" class="text-right">{{ $t('ProductDiscountCustomersPrintReport.PercentageDiscount') }}</th>
                        </tr>
            ...
            <div class="col-md-12  " style="height:30mm;">
                <div class="row">
                    <table class="table text-center">
                        <tr>
                            <td>
                                {{ $t('ProductDiscountCustomersPrintReport.ReceivedBy') }}:
                            </td>
                            <td>
                                {{ $t('ProductDiscountCustomersPrintReport.ApprovedBy') }}:
                            </td>
                            <td>
                                {{ $t('ProductDiscountCustomersPrintReport.PreparedBy') }}:
                            </td>
                        </tr>
