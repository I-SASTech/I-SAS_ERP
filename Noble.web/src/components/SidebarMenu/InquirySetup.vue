    ...
    <div v-bind:class="($i18n.locale == 'en' ||isLeftToRight()) ? 'text-left' : 'arabicLanguage'">
        <div class="setup_sidebar">
            <div class="setup_sidebar_wrapper">
                ...
                <div class="setup_menu" v-on:click="GotoPage('/InquiryProcess')" v-if="(isValid('CanViewInquiryProcess') )" style="height:85px !important">
                    ...
                    <div class="setup_menu_link">
                        <div class="setup_menu_titile">
                            {{ $t('InquirySetup.InquiryProcess') }}
                        </div>
                        <p class="setup_menu_desc">
                            {{ $t('InquirySetup.InquiryProcessDesc') }}
                        </p>
                    </div>
                </div>

                <div class="setup_menu" v-on:click="GotoPage('/InquiryModule')" v-if="(isValid('CanViewInquirySetup') )" style="height:85px !important">
                    <div class="setup_menu_icon">
                        <div class="setup_icon_wrapper">
                            <img src="Reports/Stock report.svg">
                        </div>
                ...
                <div class="setup_menu" v-on:click="GotoPage('/InquiryType')" v-if="(isValid('CanViewInquiryType') )" style="height:85px !important">
                    <div class="setup_menu_icon">
                        <div class="setup_icon_wrapper">
                            <img src="Reports/Stock report.svg">
                        </div>
                    ...
                    <div class="setup_menu_link">
                        <div class="setup_menu_titile">
                            {{ $t('InquirySetup.InquiryType') }}
                        </div>
                        <p class="setup_menu_desc">
                            {{ $t('InquirySetup.InquiryTypeDesc') }}
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-10 pt-3">
                                <h5 class="page_title  pt-3" v-bind:class="($i18n.locale == 'en' ||isLeftToRight()) ? 'text-left' : 'arabicLanguage'" style="color:white">{{ $t('InquirySetup.InquirySetup') }}</h5>
                                <nav aria-label="breadcrumb" style="color:white !important">
                                    <ol class="breadcrumb" style="color:white !important">
                                        ...
                                        <li class="breadcrumb-item active" style="color:white !important" aria-current="page">{{ $t('InquirySetup.InquirySetup') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div v-if="path == 'GeographicalSetup' ">
                    <div class="row">
                        <div class="col-12" style="text-align:center;width:250px; height:250px;margin-top:141px">
                            ...
                            <h5 class="HeadingOfEmpty">{{ $t('InquirySetup.EmptyForms') }}</h5>
                            <p>{{ $t('InquirySetup.Selectformtheleft') }}</p>
                        </div>
                    </div>
                </div>
                <div v-else>
