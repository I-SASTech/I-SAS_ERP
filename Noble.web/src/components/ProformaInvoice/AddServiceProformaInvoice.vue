<template>
    <div class="row" v-if="isValid('CanAddProforma')">
        <div class="col-lg-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 v-if="sale.id == '00000000-0000-0000-0000-000000000000'" class="page-title">{{ $t('AddProformaInvoices.AddServiceProformaInvoice') }}</h4>
                                <h4 v-else class="page-title">{{ $t('AddProformaInvoices.UpdateServiceProformaInvoice') }}</h4>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row form-group" v-if="isValid('CashServiceInvoicesForCustomer' ) || isValid('CanAddProforma')">
                    ...
                    <div class="row form-group" v-if="isValid('CanSelectServiceWarehouse')">
                        <label class="col-form-label col-lg-4">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">{{ $t('AddProformaInvoices.CustomerInquiry') }}  #</span>
                        </label>
                        <div class="inline-fields col-lg-8">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">{{ $t('AddProformaInvoices.DeliveryDate') }} </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">{{ $t('AddProformaInvoices.DeliveryAddress') }} </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                            <input class="form-control" />
                        </div>
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline "> {{ $t('AddProformaInvoices.BillingAddress') }}</span>
                        </label>
                        <div class="inline-fields col-lg-8">
                            <input class="form-control" />
                        </div>
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">{{ $t('AddProformaInvoices.InvoiceFor') }} </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                            <input v-model="sale.description" class="form-control" />
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row form-group" v-if="isValid('CanSelectServiceTransporter')">
                        <label class="col-form-label col-lg-4">
                    ...
                    <div class="row form-group" v-if="isArea=='true' && isValid('CanSelectServiceArea')">
                        <label class="col-form-label col-lg-4">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">{{ $t('AddProformaInvoices.SalePerson') }}</span>
                        </label>
                        <div class="inline-fields col-lg-8">
                            <input class="form-control" />
                        </div>
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-4">
                            <span class="tooltip-container text-dashed-underline ">{{ $t('AddProformaInvoices.ReferedBy') }} </span>
                        </label>
                        <div class="inline-fields col-lg-8">
                            <input class="form-control" />
                        </div>
                        ...
                        <div class="inline-fields col-lg-8">
                            <div :key="renderImg">
                                <div class="input-group mb-3"
                                     v-if="!((imageSrc == '' && sale.warrantyLogoPath != '') || (imageSrc != '' && sale.warrantyLogoPath == '') || (imageSrc != '' && sale.warrantyLogoPath != '')|| (imageSrc != '' && sale.warrantyLogoPath != null))">
                                ...
                                <div v-else class="mt-2">
                                    <span v-if="sale.warrantyLogoPath!=null && sale.warrantyLogoPath!=''">
                                        <img :src="'data:image/png;base64,' + sale.warrantyLogoPath" width="200" height="150" />
                                    </span>
                    ...
                    <div class="row form-group" v-if="imageSrc != '' || sale.warrantyLogoPath != ''">
                        <label class="col-form-label col-lg-4">
                        </label>
                        <div class="inline-fields col-lg-8">
                ...
                <sale-service-item :saleItems="sale.saleItems" ref="childComponentRef" :wareHouseId="sale.wareHouseId"
                                   :saleOrderId="sale.saleOrderId" @update:modelValue="SaveSaleItems" @summary="updateSummary"
                                   @discountChanging="updateDiscountChanging" :newtaxMethod="sale.taxMethod" :taxRateId="sale.taxRateId"
                                   :adjustmentProp="sale.discount" :adjustmentSignProp="adjustmentSignProp"
                                   :isDiscountOnTransaction="sale.isDiscountOnTransaction"
                                   :transactionLevelDiscountProp="sale.transactionLevelDiscount" :isFixed="sale.isFixed"
                ...
                <div class="col-lg-12 invoice-btn-fixed-bottom">
                    ...
                    <div class="button-items" >
                        <button class="btn btn-primary mr-2"
                                            v-if="isValid('CanAddProforma')"
                                            v-on:click="saveSale('ProformaInvoice',false)"
                                            v-bind:disabled="v$.$invalid || sale.isButtonDisabled">
                                        <span v-if="sale.id == '00000000-0000-0000-0000-000000000000'">
                                            {{ $t('AddProformaInvoices.ProformaInvoices') }}
                                        </span>

                                        <span v-if="sale.id != '00000000-0000-0000-0000-000000000000' ">
                                            {{ $t('AddProformaInvoices.UpdateProformaInvoices') }}
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-lg-4" style="border-right: 1px solid #eee;">
                                    <div class="form-group pe-3">
                                        ...
                                        <textarea class="form-control " rows="3" v-model="sale.termAndCondition" />
                                    </div>
                                </div>
                                <div class="col-lg-4" style="border-right: 1px solid #eee;">
                                    <div class="form-group pe-3 ps-3">
                                        <label>{{ $t('AddSaleOrder.TermAndConditionArabic') }}:</label>
                                        <textarea class="form-control " rows="3" v-model="sale.termAndConditionAr" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
...
<sale-invoice-default :color="true" :printDetails="printDetails" v-bind:isTouchScreen="addSale" :headerFooter="headerFooter" v-if="printDetails.length != 0 && printTemplate=='Default'" v-bind:key="printRender" />
...
<ObaagestSaleInvoice :printDetails="printDetails" :isTouchScreen="addSale" :headerFooter="headerFooter" v-if="printDetails.length != 0 && printSize=='A4' && printTemplate=='Template8'" v-bind:key="printRender" />
...
<script>
    ...
    return false;
        ...
        methods: {
            ...
            OnCashCustomerSelect: function () {
                if (this.sale.customerId != null || this.sale.customerId != '' || this.sale.customerId != undefined) {
                    this.sale.customerId = '';
                    this.customerAdvanceAccountId = '';
                    this.customerRender++;
                }
                this.sale.cashCustomer = this.selectedCashCustomer.name;
                if (this.selectedCashCustomer.name == 'Walk-In') {
                    this.sale.mobile = '';
                    this.sale.email = null;
                    this.sale.cashCustomerId = null;
                    this.sale.customerAddressWalkIn = '';
                }
                else {
                    this.sale.mobile = this.selectedCashCustomer.mobile;
                    this.sale.email = this.selectedCashCustomer.email;
                    this.sale.cashCustomerId = this.selectedCashCustomer.customerId;
                    this.sale.customerAddressWalkIn = this.selectedCashCustomer.address;
                }


            },
            AddNewCustomer: function (customerName) {
                if (this.sale.customerId != null || this.sale.customerId != '' || this.sale.customerId != undefined) {
                    this.sale.customerId = '';
                    this.customerAdvanceAccountId = '';
                    this.customerRender++;
                }
                this.cashCustomerOptions.push({
                    id: this.createUUID(),
                    mobile: '',
                    email: '',
                    name: customerName,
                ...
                this.selectedCashCustomer = this.cashCustomerOptions.find(function (x) {
                    return x.name == customerName;
                })
                this.sale.cashCustomer = customerName;
                this.sale.mobile = '';
                this.sale.email = '';
            ...
            getAddress: function () {
                ...
                this.sale.cashCustomerId = this.$refs.CustomerDropdown.GetCustomerAddress().vatNo;
            },
            GetCashCustomer: function () {
                var root = this;
                var token = '';
                if (token == '') {
                    token = localStorage.getItem('token');
                }
                root.$https.get('/Sale/GetCashCustomer', { headers: { "Authorization": `Bearer ${token}` } }).then(function (response) {
                    if (response.data != null) {
                        response.data.forEach(function (x) {
                            root.cashCustomerOptions.push({
                                id: x.id,
                                mobile: x.mobile,
                                email: x.email,
                                name: x.name,
                            ...
                            if (x.name == 'Walk-In') {
                                if (root.sale.customerId === null || root.sale.customerId === '' || root.sale.customerId === undefined) {
                                    root.selectedCashCustomer = root.cashCustomerOptions.find(function (x) {
                ...
                root.$https.get('/Sale/printSettingDetail', { headers: { "Authorization": `Bearer ${token}` } })
                    .then(function (response) {
                        if (response.data != null && response.data != '') {
                            ...
                            if (root.$route.query.data == undefined) {
                                root.sale.termAndCondition = response.data.termsInEng;
                                root.sale.termAndConditionAr = response.data.termsInAr;
                                root.sale.warrantyLogoPath = response.data.warrantyImageForPrint;
                                    ...
                                    if (ok != null) {
                                        if (root.sale.id == '00000000-0000-0000-0000-000000000000' && !root.sale.isDuplicate) {
                                            ...
                                            root.$router.push({
                                                ...
                                                query: {
                                                    data: 'AddServiceProformaInvoice'
                                                }
                                            });
                                        }
        ...
        created: function () {
            ...
            if (this.isValid('CashServiceInvoicesForCustomer') && !this.isValid('CashServiceInvoicesForWalkIn')) {
            ...
            if (IsDayStart != 'true') {
                ...
                if (this.$route.query.data == undefined) {
                    if ((this.$i18n.locale == 'en' || this.isLeftToRight())) {
                        ...
                        if (root.isValid('CashServiceInvoices')) {
                            root.isCredit(root.toggleCash);
                            root.sale.cashCustomer = "Walk-In";
                        }
                        else if (root.isValid('CanAddProforma')) {
