    ...
    export default {
        ...
        methods: {
            getData: function () {
                ...
                url = '/Purchase/QuotationTemplateList?isDropdown=true'
               


                this.$https.get(url + '&isService=' + this.isservice, {headers: { Authorization: `Bearer ${token}` },})
                    .then(function (response) {
                        ...
                        if (response.data != null) {
                            response.data.results.forEach(function (sup) {
                                root.options.push({
                                    id: sup.id,
                                    name: sup.description + " " + sup.registrationNumber,
                                });
                            });
                        }
                    })
