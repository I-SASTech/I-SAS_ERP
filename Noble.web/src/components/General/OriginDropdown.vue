...
<template v-slot:noResult>
            <a  class="btn btn-primary " v-on:click="AddOrigin('Add')"
                ...
                <div class="modal-body">
                    <div class="row ">
                        ...
                        <div v-if="english == 'true'" class="form-group has-label col-sm-12 "
                            ...
                            <label class="text  font-weight-bolder"> {{$englishLanguage($t('OriginDropdown.OriginName')) 
                        ...
                        <div v-if="isOtherLang()" class="form-group has-label col-sm-12 "
                            ...
                            <label class="text  font-weight-bolder"> {{$arabicLanguage($t('OriginDropdown.OriginNameAr')) 
