...
namespace Focus.Business.Terminals.Commands.DeleteTerminal
{
    public class DeleteTerminalCommand : IRequest<Guid>
    {
        public Guid Id { get; set; }

        public class Handler : IRequestHandler<DeleteTerminalCommand, Guid>
        {
            ...
            //Constructor
            public Handler(IApplicationDbContext context, ILogger<DeleteTerminalCommand> logger , IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
            ...
            public async Task<Guid> Handle(DeleteTerminalCommand request, CancellationToken cancellationToken)
            {
