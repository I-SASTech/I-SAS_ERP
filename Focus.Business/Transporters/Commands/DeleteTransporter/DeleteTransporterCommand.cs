...
namespace Focus.Business.Transporters.Commands.DeleteTransporter
{
    public class DeleteTransporterCommand : IRequest<Guid>
    {
        public Guid Id { get; set; }
        public class Handler : IRequestHandler<DeleteTransporterCommand, Guid>
        {
            ...
            public Handler(IApplicationDbContext context, ILogger<DeleteTransporterCommand> logger, IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
            ...
            public async Task<Guid> Handle(DeleteTransporterCommand request, CancellationToken cancellationToken)
            {
