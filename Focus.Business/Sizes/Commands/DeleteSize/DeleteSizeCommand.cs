...
namespace Focus.Business.Sizes.Commands.DeleteSize
{
    public class DeleteSizeCommand : IRequest<Guid>
    {
        public Guid Id { get; set; }

        public class Handler : IRequestHandler<DeleteSizeCommand, Guid>
        {
            ...
            public Handler(IApplicationDbContext context, ILogger<DeleteSizeCommand> logger, IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
            }
            public async Task<Guid> Handle(DeleteSizeCommand request, CancellationToken cancellationToken)
            {
