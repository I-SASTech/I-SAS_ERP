...
namespace Focus.Business.Products.Commands.DeleteProduct
{
    public class DeleteProductCommand:IRequest<Guid>
    {
        public Guid Id { get; set; }

        public class Handler : IRequestHandler<DeleteProductCommand, Guid>
        {
            ...
            //Constructor
            public Handler(IApplicationDbContext context, ILogger<DeleteBrandCommand> logger, IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
