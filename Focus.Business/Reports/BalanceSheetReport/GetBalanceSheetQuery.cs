...
{
    public class GetBalanceSheetQuery : IRequest<BalanceSheetListModel>
    {
        ...
        public class Handler : IRequestHandler<GetBalanceSheetQuery, BalanceSheetListModel>
        {
            ...
            public async Task<BalanceSheetListModel> Handle(GetBalanceSheetQuery request, CancellationToken cancellationToken)
            {
                try
                {
                    ...
                    string sb = "select CostCenters.Code,CostCenters.Name as CostCenter,CostCenters.NameArabic as CostCenterArabic,AccountTypes.Name as AccountType,AccountTypes.NameArabic as AccountTypeArabic," +
