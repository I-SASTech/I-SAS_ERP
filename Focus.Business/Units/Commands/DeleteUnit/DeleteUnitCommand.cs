...
namespace Focus.Business.Units.Commands.DeleteUnit
{
    public class DeleteUnitCommand : IRequest<Guid>
    {
        public Guid Id { get; set; }

        public class Handler : IRequestHandler<DeleteUnitCommand, Guid>
        {
            ...
            //Constructor
            public Handler(IApplicationDbContext context, ILogger<DeleteUnitCommand> logger, IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
