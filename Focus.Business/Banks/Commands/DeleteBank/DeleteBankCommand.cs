...
namespace Focus.Business.Banks.Commands.DeleteBank
{
    public class DeleteBankCommand : IRequest<Guid>
    {
        public Guid Id { get; set; }

        public class Handler : IRequestHandler<DeleteBankCommand, Guid>
        {
            ...
            //Constructor
            public Handler(IApplicationDbContext context, ILogger<DeleteBankCommand> logger, IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
            }
            public async Task<Guid> Handle(DeleteBankCommand request, CancellationToken cancellationToken)
            {
