...
{
    public class ReparingOrderLookUp
    {
        public Guid Id { get; set; }
        public DateTime Date { get; set; }
        public string Dates { get; set; }
        public string ExpectedDates { get; set; }
        ...
        public virtual ICollection<ReparingOrderItemLookUpModel> ReparingItems { get; set; }
        public virtual ICollection<AdvancePaymentLookUpModel> PaymentVouchers { get; set; }
