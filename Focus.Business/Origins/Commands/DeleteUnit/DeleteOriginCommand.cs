...
namespace Focus.Business.Origins.Commands.DeleteUnit
{
    public class DeleteOriginCommand : IRequest<Guid>
    {
        public Guid Id { get; set; }

        public class Handler : IRequestHandler<DeleteOriginCommand, Guid>
        {
            ...
            //Constructor
            public Handler(IApplicationDbContext context, ILogger<DeleteOriginCommand> logger, IMediator mediator)
            {
                _context = context;
                _logger = logger;
                _mediator = mediator;
            }
            public async Task<Guid> Handle(DeleteOriginCommand request, CancellationToken cancellationToken)
            {
