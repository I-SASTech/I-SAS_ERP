...
namespace Noble.Report.Reports.TuchInvoice
{
    ...
    public partial class SA_TP_Default : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public SA_TP_Default(CompanyDto companyDto, PrintSetting printSetting, SaleDetailLookupModel saleDetail)
        {
            InitializeComponent();
