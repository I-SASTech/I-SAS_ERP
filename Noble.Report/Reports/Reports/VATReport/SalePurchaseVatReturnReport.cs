...
{
    public partial class SalePurchaseVatReturnReport : DevExpress.XtraReports.UI.XtraReport
    {
        public SalePurchaseVatReturnReport(CompanyDto companyDtl, VatReturnLookUpModel vatReturnLook, DateTime fromTime, DateTime toTime,string currency)
        {
            InitializeComponent();
            ...
            SumOfAdjustment.Text = Adjustment.Text;
            ...
            PurchaseAdjustment.Text = (0).ToString("N2");
            TotalPurchaseAdjustment.Text = PurchaseAdjustment.Text;
