...
{
    public partial class AdvanceIInventoryItemComparison : DevExpress.XtraReports.UI.XtraReport
    {
        public AdvanceIInventoryItemComparison(CompanyDto company, List<AdvanceInventoryItemLookupMdoel> inventoryInfo, string compairWith, string comparePeriod)
        {
            InitializeComponent();
