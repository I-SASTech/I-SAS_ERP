...
{
    public partial class AdvanceQuantityWiseInventoryComparison : DevExpress.XtraReports.UI.XtraReport
    {
        public AdvanceQuantityWiseInventoryComparison(CompanyDto company, List<AdvanceQuantityWiseInventoryItemLookupModel> inventoryInfo, string compairWith, string comparePeriod)
        {
            InitializeComponent();
