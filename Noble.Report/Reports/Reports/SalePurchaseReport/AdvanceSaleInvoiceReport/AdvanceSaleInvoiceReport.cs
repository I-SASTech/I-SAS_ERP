...
{
    public partial class AdvanceSaleInvoiceReport : DevExpress.XtraReports.UI.XtraReport
    {
        public AdvanceSaleInvoiceReport(CompanyDto company, List<SaleInvoiceSummaryLookupModel> sale,string compairWith,string comparePeriod)
        {
            InitializeComponent();
            CompanyInfo.DataSource = company;
            SaleInvoice.DataSource=sale;
