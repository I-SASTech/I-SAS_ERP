...
{
    public partial class StockRecievedTemplet6 : DevExpress.XtraReports.UI.XtraReport
    {
        public StockRecievedTemplet6(CompanyDto companyDto, StockReceivedLookupModel stockInfo, PrintSetting printSetting)
        {
            InitializeComponent();
