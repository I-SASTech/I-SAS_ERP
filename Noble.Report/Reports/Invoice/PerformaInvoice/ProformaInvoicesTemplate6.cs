...
{
    public partial class ProformaInvoicesTemplate6 : DevExpress.XtraReports.UI.XtraReport
    {
        public ProformaInvoicesTemplate6(CompanyDto companyDto, PrintSetting printSetting, SaleDetailLookupModel saleDetail)
        {
            InitializeComponent();
            ...
            {
                invoiceType = "";
                invoiceTypeAr = "Customer PO     أمر شراء العميل";
