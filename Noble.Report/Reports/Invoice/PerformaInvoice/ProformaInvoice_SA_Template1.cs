...
{
    public partial class ProformaInvoice_SA_Template1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ProformaInvoice_SA_Template1(CompanyDto companyDto, PrintSetting printSetting, SaleDetailLookupModel saleDetail)
        {
            InitializeComponent();
