...
{
    public partial class Templet3 : DevExpress.XtraReports.UI.XtraReport
    {
        public Templet3(CompanyDto company, PaymentVoucherLookUpModel paymentVoucherLookUpModel, PrintSetting printSetting)
        {
            InitializeComponent();
