...
{
    public partial class PurchaseInvoice_SATemplate6 : DevExpress.XtraReports.UI.XtraReport
    {
        public PurchaseInvoice_SATemplate6(CompanyDto companyDto, PrintSetting printSetting, PurchasePostLookupModel saleDetail)
        {
            InitializeComponent();
            ...
            SupplierAddress.Text = saleDetail.SupplierAddress;
