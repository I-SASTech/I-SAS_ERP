...
{
    public static class GetCostCenter
    {

        public static AdvanceCostCenterLookupModel GetCostCenterDtl (string token,string serverName) {
          ...
          var   CostCenter = JsonConvert.DeserializeObject<AdvanceCostCenterLookupModel>(content1);
